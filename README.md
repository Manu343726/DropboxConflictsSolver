...
Aunque ese es el cometido original para lo que fue desarrollado, el programa permite tanto la búsqueda como la eliminación de archivos 
utilizando una expresión regular para filtrarlos (Por nombre).
...
regex: Expresión regular utilizada para filtrar los archivos. Dicha regex se aplica al nombre del archivo (Extensión incluida), no a su 
       path completo.
...
El programa es un sencillo proyecto de consola desarrollado con C# (.NET Framework 4.5). El código no está licenciado, pero cualquiera que 
